...
1. **Bước 1 (Giao Tiếp AI)**: Truy cập Bot Telegram - gõ username `@trasuadee_bot` vào thanh tìm kiếm trên Telegram hoặc click vào link sau: `https://web.telegram.org/a/#8701359518`, sau đó nhắn tin gọi món bằng ngôn ngữ tự nhiên theo kịch bản:
